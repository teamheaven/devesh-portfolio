      ...
      <div className="section-shell grid min-h-[calc(100vh-6rem)] items-center gap-12 pb-16 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          >
            ...
            <motion.a whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.98 }} href="public/Devesh Naik.pdf" download className="focus-ring inline-flex items-center gap-2 rounded-full border border-blue-300/20 bg-white/[0.06] px-5 py-3 text-sm font-semibold text-blue-50 transition hover:border-blue-300/50 hover:bg-blue-400/10">
